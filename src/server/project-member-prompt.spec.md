...
You are working on project branch `${projectBranch}`, which was created from the team's main branch. All implementation work happens here in an isolated worktree.
